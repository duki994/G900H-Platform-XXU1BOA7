...
std::string CheckAndGetAndroidDeviceName (std::string android_device_name) {
...
#if defined(OS_ANDROID)
  return CheckAndGetAndroidDeviceName(std::string(device_model_str));
#else
...
#if defined(S_SYSINFO_GETLANGUAGE)
