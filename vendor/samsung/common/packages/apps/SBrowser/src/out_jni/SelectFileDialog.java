...
public class SelectFileDialog implements WindowAndroid.IntentCallback{
    ...
    private void selectFile(String[] fileTypes, boolean capture, WindowAndroid window) {
        ...
        if (captureCamera()) {
            if (window.showIntent(camera, this, com.sec.android.app.sbrowser.R.string.low_memory_error)) return;
        } else if (captureCamcorder()) {
            if (window.showIntent(camcorder, this, com.sec.android.app.sbrowser.R.string.low_memory_error)) return;
        } else if (captureMicrophone()) {
            if (window.showIntent(soundRecorder, this, com.sec.android.app.sbrowser.R.string.low_memory_error)) return;
        }
        ...
        if (!window.showIntent(chooser, this, com.sec.android.app.sbrowser.R.string.low_memory_error)) {
            onFileNotSelected();
        }
    }
    ...
    public void onIntentCompleted(WindowAndroid window, int resultCode,
      ...
      //Samsung change ++
        ...
        if(!isAsyncTaskRunning){
	        onFileNotSelected();
	        window.showError(com.sec.android.app.sbrowser.R.string.opening_file_error);
        }
      //Samsung change --
    }
