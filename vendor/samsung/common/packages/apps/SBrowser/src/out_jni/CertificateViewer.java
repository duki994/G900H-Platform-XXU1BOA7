...
class CertificateViewer implements OnItemSelectedListener {
    ...
    private CertificateViewer(Context context) {
        ...
        mPadding = (int) context.getResources().getDimension(
                com.sec.android.app.sbrowser.R.dimen.certificate_viewer_padding) / 2;
    }
    ...
    private void showCertificateChain(byte[][] derData) {
        ...
        //SAMSUNG : certificate viewer spinner size
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(mContext,
                com.sec.android.app.sbrowser.R.layout.certificate_spinner_item,
                mTitles);
        arrayAdapter.setDropDownViewResource(com.sec.android.app.sbrowser.R.layout.certificate_spinner_dropdown_item);
    ...
    private void showDialogForView(View view) {
        ...
        //SAMSUNG : certificate viewer string
        dialog.setTitle(com.sec.android.app.sbrowser.R.string.certificate_title);
