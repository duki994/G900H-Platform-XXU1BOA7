...
class WebsiteSettingsPopup implements OnClickListener {
    ...
    private WebsiteSettingsPopup(Context context, ContentViewCore contentViewCore,
        ...
        mPadding = (int) context.getResources().getDimension(com.sec.android.app.sbrowser.R.dimen.certificate_viewer_padding);
    ...
    private void addSection(int enumeratedIconId, String headline, String description) {
        View section = LayoutInflater.from(mContext).inflate(com.sec.android.app.sbrowser.R.layout.website_settings, null);
        //SAMSUNG : certificate viewer - delete icon
        //ImageView i = (ImageView) section.findViewById(com.sec.android.app.sbrowser.R.id.website_settings_icon);
        //int drawableId = ResourceId.mapToDrawableId(enumeratedIconId);
        //i.setImageResource(drawableId);

        TextView h = (TextView) section.findViewById(com.sec.android.app.sbrowser.R.id.website_settings_headline);
        h.setText(headline);
        if (TextUtils.isEmpty(headline)) h.setVisibility(View.GONE);

        TextView d = (TextView) section.findViewById(com.sec.android.app.sbrowser.R.id.website_settings_description);
    ...
    private void setCertificateViewer(String label) {
        ...
        mCertificateViewer.setFocusable(true);
        mCertificateViewer.setFocusableInTouchMode(true);
        mContainer.addView(mCertificateViewer);
    }

    @CalledByNative
    private void addMoreInfoLink(String linkText) {
        //SAMSUNG : certificate viewer - remove help link 
