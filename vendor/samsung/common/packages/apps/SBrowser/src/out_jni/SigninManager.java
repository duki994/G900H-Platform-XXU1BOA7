...
public class SigninManager {
    ...
    private void onPolicyCheckedBeforeSignIn(String managementDomain) {
        ...
        builder.setTitle(com.sec.android.app.sbrowser.R.string.policy_dialog_title);
        builder.setMessage(mContext.getResources().getString(com.sec.android.app.sbrowser.R.string.policy_dialog_message,
                                                             managementDomain));
        builder.setPositiveButton(
                com.sec.android.app.sbrowser.R.string.policy_dialog_proceed,
        ...
        builder.setNegativeButton(
                com.sec.android.app.sbrowser.R.string.policy_dialog_cancel,
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int id) {
    ...
    private void wipeProfileData(Activity activity) {
        if (activity != null) {
            ...
            mSignOutProgressDialog = ProgressDialog.show(
                activity,
                activity.getString(com.sec.android.app.sbrowser.R.string.wiping_profile_data_title),
                activity.getString(com.sec.android.app.sbrowser.R.string.wiping_profile_data_message),
