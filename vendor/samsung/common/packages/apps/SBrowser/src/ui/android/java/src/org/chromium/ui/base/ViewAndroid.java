...
public class ViewAndroid {
    private static final String TAG = "ViewAndroid";
    ...
    public void incrementKeepScreenOnCount() {
        mKeepScreenOnCount++;
        Log.d(TAG, "incrementKeepScreenOnCount with mKeepScreenOnCount : " + mKeepScreenOnCount);
        if (mKeepScreenOnCount == 1) {
            Log.d(TAG, "set KeepScreenOn on");
    ...
    public void decrementKeepScreenOnCount() {
        ...
        mKeepScreenOnCount--;
        Log.d(TAG, "decrementKeepScreenOnCount with mKeepScreenOnCount : " + mKeepScreenOnCount);
        if (mKeepScreenOnCount == 0) {
            Log.d(TAG, "set KeepScreenOn off");
