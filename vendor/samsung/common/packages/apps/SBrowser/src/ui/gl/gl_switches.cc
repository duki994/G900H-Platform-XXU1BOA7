...
// Expand soft-limit of GPU memory on low end device mode.
const char kExpandMemoryLimitOnLowEndDevice[] = "expand-memory-limit-on-low-end";
...
namespace GPU_INFO{
 ...
 bool Gpuinfo::GetCanUseGpuMemory()
  {	
	return content::GpuMemoryBufferImplAndroidSEC::CanUseGpuMemory(); // will return wether we can use gpumemory based on fd count
  }
}
#endif
