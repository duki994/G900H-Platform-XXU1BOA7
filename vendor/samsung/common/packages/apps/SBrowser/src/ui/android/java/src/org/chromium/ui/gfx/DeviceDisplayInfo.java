...
public class DeviceDisplayInfo {
    ...
    public float calcDeviceInch() {
        ...
        float result = (float)Math.sqrt((widthpx / metrics.xdpi)*(widthpx / metrics.xdpi) + (heightpx / metrics.ydpi)*(heightpx / metrics.ydpi));
        return result;
    }
