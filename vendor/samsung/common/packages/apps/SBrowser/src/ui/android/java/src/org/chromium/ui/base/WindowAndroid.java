...
public class WindowAndroid {
    ...
    */
    ...
    /**
     * @return A reference to owning Activity.  The returned WeakReference will
     * never be null, but the contained Activity can be null (either if it has
     * been garbage collected or if this is in the context of a WebView that was
     * not created using an Activity).
    */
