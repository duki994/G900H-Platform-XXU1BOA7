...
public class BrowserContract {
    public static final String AUTHORITY = "com.sec.android.app.sbrowser.mozilla";
...
//    public static final String TABS_AUTHORITY = AppConstants.ANDROID_PACKAGE_NAME + ".db.tabs";
    ...
    public static final String TABS_AUTHORITY = "com.sec.android.app.sbrowser.mozilla";
    ...
    public static final String FIREFOX_SYNC_BROADCAST_ACTION = "android.intent.action.MOZILLA_FIREFOX_SYNC";
    public static final int TAB_SYNC_STARTED = 8000;
    public static final int BOOKMARK_SYNC_STARTED = TAB_SYNC_STARTED + 1;
