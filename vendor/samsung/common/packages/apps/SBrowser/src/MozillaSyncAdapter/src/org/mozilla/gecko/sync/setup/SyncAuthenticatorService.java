...
import com.sec.android.app.sbrowser.firefox.FxAccountCreateAccountActivity;
...
public class SyncAuthenticatorService extends Service {
  ...
  private static class SyncAccountAuthenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response,
      ...
      final Intent intent = new Intent(mContext, FxAccountCreateAccountActivity.class);
    ...
    public Bundle getAccountRemovalAllowed(final AccountAuthenticatorResponse response, Account account)
      ...
      sendMozillaSignoutBroadcast();

      return result;
    }
    
    public void sendMozillaSignoutBroadcast(){
    	Intent intent = new Intent();
        intent.putExtra("SIGN", 3);//If value is 1 signin. If value is 2 sign in fail. If value is 3 signed out.
        intent.setAction("android.intent.action.MOZILLA_FIREFOX_ACCOUNT_SIGNOUT");
