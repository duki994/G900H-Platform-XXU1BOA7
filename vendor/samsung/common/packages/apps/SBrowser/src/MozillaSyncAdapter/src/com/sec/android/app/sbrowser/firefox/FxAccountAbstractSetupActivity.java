...
abstract public class FxAccountAbstractSetupActivity extends FxAccountAbstractActivity implements ProgressDisplay {
  ...
  public void showRemoteError(final Exception e, int defaultResourceId) {
    if (e instanceof IOException) {
      ...
      if (!((FxAccountClientRemoteException)e).isAccountAlreadyExists()) {
          showClientRemoteException(((FxAccountClientRemoteException)e));
          return;
        }
        ...
        final String message = getString(((FxAccountClientRemoteException)e).getErrorMessageStringResource(), clickablePart);
        ...
        span.setSpan(new ClickableSpan() {
          ...
          public void onClick(View widget) {
            ...
            String email = ((FxAccountClientRemoteException)e).body.getString("email");
            if (email == null) {
  ...
  private void doSigninInstead(final String email, final String password) {
  ...
  public abstract class AddAccountDelegate implements RequestDelegate<LoginResponse> {
