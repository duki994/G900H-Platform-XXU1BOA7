...
void NetLogLogger::StartObserving(NetLog* net_log, int logLevel) {
  switch(logLevel) {
    case net::NetLog::LOG_ALL:
	LOG(INFO) << "NetLogLogger::StartObserving - net::NetLog::LOG_ALL";
        net_log->AddThreadSafeObserver(this, net::NetLog::LOG_ALL);
        break;
    case net::NetLog::LOG_ALL_BUT_BYTES:
	LOG(INFO) << "NetLogLogger::StartObserving - net::NetLog::LOG_ALL_BUT_BYTES";
        net_log->AddThreadSafeObserver(this, net::NetLog::LOG_ALL_BUT_BYTES);
        break;
    case net::NetLog::LOG_BASIC:   
	LOG(INFO) << "NetLogLogger::StartObserving - net::NetLog::LOG_BASIC";
        net_log->AddThreadSafeObserver(this, net::NetLog::LOG_BASIC);
        break;
    case net::NetLog::LOG_NONE:   
        net_log->AddThreadSafeObserver(this, net::NetLog::LOG_NONE);
        break;
    default:
        NOTREACHED();
  }
