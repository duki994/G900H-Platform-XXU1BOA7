...
public class DefaultAndroidKeyStore implements AndroidKeyStore {
   ...
   @Override
    ...
    public byte[] rawSignDigestWithPrivateKey(AndroidPrivateKey key,
        ...
        } catch (SignatureException e) {   //changed from Exception to Specific Exception
    ...
    public int getOpenSSLHandleForPrivateKey(AndroidPrivateKey key) {
        ...
        } catch (ClassNotFoundException e) { //changed Exception
        ...
        try {
            ...
            } catch (NoSuchMethodException e) { //changed Exception
       ...
       } catch( IllegalAccessException e){ //changed Exception
