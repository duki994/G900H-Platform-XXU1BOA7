...
// SAMSUNG CHANGE: idle connection closing immediately after loading finished.
  bool main_frame_load_finished() const { return main_frame_load_finished_;}
  void set_main_frame_load_finished(bool finished){
   main_frame_load_finished_ = finished;
 }
// SAMSUNG CHANGE
...
// SAMSUNG CHANGE: idle connection closing immediately after loading finished.
  bool main_frame_load_finished_;
// SAMSUNG CHANGE
