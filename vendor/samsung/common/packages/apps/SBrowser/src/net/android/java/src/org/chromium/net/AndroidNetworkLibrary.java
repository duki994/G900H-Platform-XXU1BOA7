...
public class AndroidNetworkLibrary {
    ...
    public static interface CertificateErrorObserver {
        public void notify(int type, boolean is_expired);
    }
     ...
     */
    @CalledByNative
    public static void notifyCertificateError(int type, boolean is_expired) {
        if (sCertificateErrorObserver != null) {
            sCertificateErrorObserver.notify(type, is_expired);
        }
    }
    // SAMSUNG : send_cert_error_type_to_mdm <<
}
