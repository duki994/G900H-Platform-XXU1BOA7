...
public class X509Util {
    ...
    private static final int CERT_STATUS_DATE_NOT_YET_VALID = 1 << 20;
    private static final int CERT_STATUS_DATE_EXPIRED = 1 << 21;
    // SAMSUNG : send_cert_error_type_to_mdm <<

    // SAMSUNG : certificate_revocation start >>
    public static interface CertificateErrorChecker {
        /*
    ...
    private static CertificateErrorChecker sCertificateErrorChecker = null;

    public static void setCertificateErrorChecker(CertificateErrorChecker checker) {
        sCertificateErrorChecker = checker;
    }
        ...
        synchronized (sLock) {
            ...
            try {
                ...
                try {
                    ...
                    // SAMSUNG : certificate_revocation start >>
                    if (sCertificateErrorChecker != null)
                        return new AndroidCertVerifyResult(sCertificateErrorChecker.check(eDefaultManager));
                    // SAMSUNG : certificate_revocation end <<
                    return new AndroidCertVerifyResult(
