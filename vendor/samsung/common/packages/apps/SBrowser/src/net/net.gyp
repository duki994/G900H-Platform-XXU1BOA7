  ...
  'targets': [
	...
	'http/failing_http_transaction_factory.h',
      ...
      'conditions': [
        ...
        ['OS=="android" and _toolset=="target" and android_webview_build == 0 and enable_s_android_browser == 0' , {
          'dependencies': [
             'net_java',
          ],
        }],
        ['OS=="android" and _toolset=="target" and android_webview_build == 0 and enable_s_android_browser_unittest == 1' , {
          'dependencies': [
             'net_java',
          ],
        }],
        ['OS=="android" and _toolset=="target" and android_webview_build == 0 and enable_s_android_browser == 1' , {
          'dependencies': [
            '../base/base.gyp:base',
