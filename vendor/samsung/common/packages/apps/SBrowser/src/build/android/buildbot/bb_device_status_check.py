...
def main():
  ...
  parser.add_option('--release', action='store_true',
                    help='Release build type. Forwarded to adb_install_apk.py.')
  parser.add_option('--debug', action='store_false',
                    help='Debug build type. Forwarded to adb_install_apk.py.')
