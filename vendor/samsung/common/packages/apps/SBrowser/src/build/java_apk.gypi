      ...
      'actions': [
        ...
        },
        {
          ...
          'variables': {
            ...
            'stamp': '<(strip_stamp)',
	    'use_lzma_zip': 0,
            'stripped_libraries_out_dir': 'none',
	    'zip_libraries_dir': 'none',            
            'package_stamp': 'none',
          },
	  'conditions': [
            ['low_end_target == 1', {
		'variables': {			    
		  'stripped_libraries_out_dir': '<@(PRODUCT_DIR)/stripped_libs',
		  'zip_libraries_dir': '<@(PRODUCT_DIR)/../assets/<(_target_name)',
  	          'use_lzma_zip': 1,
                  'package_stamp': '<(package_resources_stamp)',		    
		 },	
            }],
          ],
