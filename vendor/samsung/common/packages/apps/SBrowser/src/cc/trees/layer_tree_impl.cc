...
void LayerTreeImpl::SetDeferCommitOnImpl(bool defer) {
  return layer_tree_host_impl_->SetDeferCommitOnImpl(defer);
}
#endif
...
bool LayerTreeImpl::IsFastFling() {
  return layer_tree_host_impl_->faste_fling();
}
#endif
