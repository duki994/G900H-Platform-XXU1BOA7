...
class KeyStoreSelectionDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        final CharSequence[] choices = {
            //SAMSUNG : fix smart card selection dialog string
            getText(R.string.smartcard_btn_smart_card),
            getText(R.string.smartcard_btn_android)
        };
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
                ...
                .setSingleChoiceItems(choices, 0, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        if (choices[id] == getText(R.string.smartcard_btn_android)) {
