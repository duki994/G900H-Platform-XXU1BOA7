...
class PasswordManager : public LoginModel {
 public:
  ...
  // Handles Autofill for Hidden Forms when Extra Authentication is required.
  void OnHiddenFormAutofill(const autofill::PasswordFormFillData &h_fill_data);
  #endif

  #if defined(S_FP_NEW_TAB_FIX)
  void OnRPPCheckBeforeTabClose();
  #endif
