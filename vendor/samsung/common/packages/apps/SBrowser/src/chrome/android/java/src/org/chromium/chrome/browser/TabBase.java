...
public abstract class TabBase implements NavigationClient {
    ...
    /**
     * Called when the touchicon of the content this tab represents changes.
     */
    @CalledByNative
    protected void onTouchiconUpdated() {
        mFavicon = null;
        mFaviconUrl = null;
        for (TabObserver observer : mObservers) observer.onTouchiconUpdated(this);
    }
