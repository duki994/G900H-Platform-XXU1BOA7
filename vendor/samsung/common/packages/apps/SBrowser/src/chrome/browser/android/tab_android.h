...
class TabAndroid : public CoreTabHelperDelegate,
 ...
 public:
  ...
  long GetWebContentsPtr(JNIEnv* env, jobject obj);
  // SBROWSER_MULTIINSTANCE_TAB_DRAG_N_DROP>>
 ...
 private:
  ...
  content::WebContents* SbrCreateTargetContents(const chrome::NavigateParams& params,
                                                const GURL& url);

  void SbrLoadURLInContents(content::WebContents* target_contents, const GURL& url,
