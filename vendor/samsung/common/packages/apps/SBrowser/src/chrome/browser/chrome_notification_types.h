...
enum NotificationType {
  ...
  // Sent by FaviconTabHelper when a tab's Touchicon has been successfully
  // updated. The details are a bool indicating whether the
  // NavigationEntry's Touchicon URL has changed since the previous
  // NOTIFICATION_TOUCHICON_UPDATED notification. The details are true if
  // there was no previous NOTIFICATION_TOUCHICON_UPDATED notification for the
  // current NavigationEntry.
  NOTIFICATION_TOUCHICON_UPDATED,
