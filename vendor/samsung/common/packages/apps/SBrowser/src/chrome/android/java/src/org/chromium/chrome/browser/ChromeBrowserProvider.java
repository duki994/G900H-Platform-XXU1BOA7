...
public class ChromeBrowserProvider extends ContentProvider {
    ...
    static final String CLIENT_API_IS_CHROME_INITIALIZED =
            "CLIENT_API_IS_CHROME_INITIALIZED";
    ...
    // This authority and path are for SBrowserProviderProxy used for China model without chorme.
    private static final String PROXY_AUTHORITY_SUFFIX = ".BrowserProviderProxy";
    private static final String BOOKMARKS_PATH_EX = "bookmarks_ex";
    private static final String SEARCHES_PATH_EX = "searches_ex";
    ...
    private void ensureUriMatcherInitialized() {
        synchronized (mInitializeUriMatcherLock) {
            ...
            // To support proxy authority .BrowserProviderProxy
            String proxyAuthority = getContext().getPackageName() + PROXY_AUTHORITY_SUFFIX;
            mUriMatcher.addURI(proxyAuthority, HISTORY_PATH, URL_MATCH_API_HISTORY_CONTENT);
            mUriMatcher.addURI(proxyAuthority, HISTORY_PATH + "/#", URL_MATCH_API_HISTORY_CONTENT_ID);
            mUriMatcher.addURI(proxyAuthority, COMBINED_PATH, URL_MATCH_API_BOOKMARK);
            mUriMatcher.addURI(proxyAuthority, COMBINED_PATH + "/#", URL_MATCH_API_BOOKMARK_ID);
            mUriMatcher.addURI(proxyAuthority, SEARCHES_PATH, URL_MATCH_API_SEARCHES);
            mUriMatcher.addURI(proxyAuthority, SEARCHES_PATH + "/#", URL_MATCH_API_SEARCHES_ID);
            mUriMatcher.addURI(proxyAuthority, BOOKMARKS_PATH, URL_MATCH_API_BOOKMARK_CONTENT);
            mUriMatcher.addURI(proxyAuthority, BOOKMARKS_PATH + "/#",URL_MATCH_API_BOOKMARK_CONTENT_ID);
            mUriMatcher.addURI(proxyAuthority, BOOKMARKS_PATH_EX, URL_MATCH_API_BOOKMARK);
            mUriMatcher.addURI(proxyAuthority, BOOKMARKS_PATH_EX + "/#", URL_MATCH_API_BOOKMARK_ID);
            mUriMatcher.addURI(proxyAuthority, SEARCHES_PATH_EX, URL_MATCH_API_SEARCHES);
            mUriMatcher.addURI(proxyAuthority, SEARCHES_PATH_EX + "/#", URL_MATCH_API_SEARCHES_ID);
        }
    }
    ...
    public Bundle call(String method, String arg, Bundle extras) {
       ...
       //  Binder.getCallingPid(), Binder.getCallingUid(), TAG);
        ...
        } else if (CLIENT_API_IS_CHROME_INITIALIZED.equals(method)){
            result.putBoolean(CLIENT_API_RESULT_KEY, ensureNativeChromeLoaded());
        } else {
