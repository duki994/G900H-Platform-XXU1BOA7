...
class FaviconHandlerDelegate {
 public:
  ...
  // |icon_url_changed| is true if a Touchicon with a different icon URL has
  // been selected since the previous call to NotifyTouchiconUpdated().
  virtual void NotifyTouchiconUpdated(bool icon_url_changed) = 0;
