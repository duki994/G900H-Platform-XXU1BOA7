...
#if !defined(S_DO_NOT_KEEP_SESSION_COOKIE)
#if defined(OS_ANDROID)
...
#else // !defined(S_DO_NOT_KEEP_SESSION_COOKIE)
  content::CookieStoreConfig::SessionCookieMode session_cookie_mode =
...
#if defined(ENABLE_PUSH_API)
content::PushPermissionContext*
    ProfileImpl::GetPushPermissionContext() {
  return ChromePushPermissionContextFactory::GetForProfile(this);
}
#endif
