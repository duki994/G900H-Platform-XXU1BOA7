...

{
  'targets': [
    {
      ...
      'sources': [
        ...
        'browser/push_registration/chrome_push_permission_context.cc',
        'browser/push_registration/chrome_push_permission_context.h',
        'browser/push_registration/chrome_push_permission_context_factory.cc',
        'browser/push_registration/chrome_push_permission_context_factory.h',
        'browser/push_registration/push_infobar_delegate.cc',
        'browser/push_registration/push_infobar_delegate.h',
 ...
 # Removed the files which are not required for Android
          'sources!': [
            'browser/notifications/balloon.cc',
            'browser/notifications/balloon.h',
            'browser/notifications/balloon_collection.cc',
        ...
        ['enable_signin==0', {
          'sources/': [
            ...
            ['exclude', '^browser/android/signin/'],
          ],
          'sources!': [
            'browser/history/web_history_service.cc',
            'browser/history/web_history_service.h',
      ...
      'targets': [
        {
          ...
          'conditions': [
            ...
            ['enable_s_android_browser==1', {
              'sources': [
                '../out_jni/CertificateViewer.java',
                '../out_jni/SigninManager.java',
                '../out_jni/WebsiteSettingsPopup.java',
                '../out_jni/InfoBar.java',
              ],
              'sources!': [
                'android/java/src/org/chromium/chrome/browser/CertificateViewer.java',
                'android/java/src/org/chromium/chrome/browser/signin/SigninManager.java',
