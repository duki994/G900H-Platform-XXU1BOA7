...
public class ChromeHttpAuthHandler {
    ...
    //Samsung SSO Kerberos feature
    public int IsNegotiateAuthSchemePresent() {
        return nativeIsNegotiateAuthSchemePresent(mNativeChromeHttpAuthHandler);
    }
    // S_USE_SYSTEM_PROXY_AUTH_CREDENTIAL
    public boolean getIsProxyAuth() {
        return nativeGetIsProxyAuth(mNativeChromeHttpAuthHandler);
    }

    public boolean getDidUseHttpAuth() {
        return nativeGetDidUseHttpAuth(mNativeChromeHttpAuthHandler);
    }
    ...
    // S_USE_SYSTEM_PROXY_AUTH_CREDENTIAL
    private native boolean nativeGetIsProxyAuth(long nativeChromeHttpAuthHandler);
    private native boolean nativeGetDidUseHttpAuth(long nativeChromeHttpAuthHandler);
    private native int nativeIsNegotiateAuthSchemePresent(long nativeChromeHttpAuthHandler); //Samsung SSO Kerberos feature
}
