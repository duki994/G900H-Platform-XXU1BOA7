...
class PasswordFormManager : public PasswordStoreConsumer {
 public:
  ...
  bool tabShouldDestroy() { return tab_should_destroy_ ;}

  void setTabShouldDestroy(bool tab_should_destroy){
  	tab_should_destroy_ = tab_should_destroy;
  }
  #endif
  ...
  bool CheckUserAlreadyExist(const autofill::PasswordForm& credentials);
  #endif
