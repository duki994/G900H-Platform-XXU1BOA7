...
var BrowserBridge = (function() {
  ...
  BrowserBridge.prototype = {
    ...
    setMaxNumDelayableRequestsPerClient: function(num) {
      this.send('setMaxNumDelayableRequestsPerClient', [num]);
    },

    setMaxNumDelayableRequestsPerHost: function(num) {
      this.send('setMaxNumDelayableRequestsPerHost', [num]);
    },

    setMaxSocketsPerGroup: function(num) {
      this.send('setMaxSocketsPerGroup', [num]);
    },
