...
public class ShortcutHelper {
    ...
    public static final String COMPONENT_NAME = "com.sec.android.app.sbrowser";

    private static String sFullScreenAction;
    private static boolean mIsWebAppSupported = false;
    /**
    ...
    public static void setWebAppSupport(boolean supportWebApp) {
    	mIsWebAppSupported = supportWebApp;
    }
    /**
    ...
    private static void addShortcut(Context context, String url, String title, Bitmap favicon,
        ...
        if (isWebappCapable && mIsWebAppSupported) {
            ...
            //FIXME: use manifest entry to resolve this intent : nagaraj.l@samsung.com
            shortcutIntent.setComponent(new ComponentName(COMPONENT_NAME,sFullScreenAction));
