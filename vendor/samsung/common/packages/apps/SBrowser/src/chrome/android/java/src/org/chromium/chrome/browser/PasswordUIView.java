...
public final class PasswordUIView {
	...
	private final boolean mAdditionalAuthentication;

        private SavedPasswordEntry(String url, String name,boolean additionalAuthentication) {
            mUrl = url;
            mName = name;
	    mAdditionalAuthentication= additionalAuthentication;
        }
	...
	public boolean getAdditionalAuthentication(){
	   return mAdditionalAuthentication;
	}
    }

    @CalledByNative
    private static SavedPasswordEntry createSavedPasswordEntry(String url, String name,boolean additionalAuthentication) {
        return new SavedPasswordEntry(url, name, additionalAuthentication);
    }
