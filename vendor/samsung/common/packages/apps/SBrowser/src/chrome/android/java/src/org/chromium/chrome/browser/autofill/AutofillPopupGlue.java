...
public class AutofillPopupGlue implements AutofillPopupDelegate{
    ...
    public AutofillPopupGlue(long nativeAutofillPopupViewAndroid, WindowAndroid windowAndroid,
        ...
        if (activity == null) {
          mAutofillPopup = null;
          // Clean up the native counterpart. This is posted to allow the native
          // counterpart to fully finish the construction of this glue object
          ...
          mAutofillPopup = new AutofillPopup(activity, containerViewDelegate,
                  this);
        }
    }
