...
public class ChromiumTestShellApplication extends ChromiumApplication {
    ...
    private static final String[] CHROME_MANDATORY_LIBS = {
                "libsecv8.so", "libchromiumtestshell.so"};
    ...
    public void onCreate() {
        ...
        LibraryLoader.unZipNativeLib(getApplicationContext(), ResourceExtractor.getNativeLibraryDirFromContext(getApplicationContext()), CHROME_MANDATORY_LIBS);
        LibraryLoader.loadSBrowserMandatoryLibs(); 
