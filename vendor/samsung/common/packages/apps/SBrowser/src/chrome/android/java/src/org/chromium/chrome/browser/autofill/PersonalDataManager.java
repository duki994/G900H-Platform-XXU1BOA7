...
public class PersonalDataManager {
	...
	//Samsung Change - Callback for already added profile >>
        public abstract void onAutoFillDataUpdateFail();
	//Samsung Change - Callback for already added profile <<
    }
...
//Samsung Change - Callback for already added profile >>
    @CalledByNative
    public void AutoFillDataUpdateFail() {
	 ThreadUtils.assertOnUiThread();
        for (PersonalDataManagerObserver observer : mDataObservers) {
            observer.onAutoFillDataUpdateFail();
        }
    }
//Samsung Change - Callback for already added profile <<
    /**
