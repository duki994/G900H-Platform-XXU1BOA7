...
public class ChromeBrowserProviderClient {
    ...
    public static void ensureNativeChromeInitialised(Context context) {
        chromeBrowserProviderCall(Boolean.class,
                ChromeBrowserProvider.CLIENT_API_IS_CHROME_INITIALIZED, context,
                argsToBundle());
    }
}
