...
#include "sbrowser/chrome/native/browser/android/sbr/notification/sbr_notification_ui_manager_android.h"
#endif
...
/*
 * Message Center Notification and Balloon Notification are not used for
 * Android so we are not creating the object of them.
 */

#if defined(S_NATIVE_SUPPORT)
  NotificationUIManagerImpl* notification_manager = new NotificationUIManagerImpl();
