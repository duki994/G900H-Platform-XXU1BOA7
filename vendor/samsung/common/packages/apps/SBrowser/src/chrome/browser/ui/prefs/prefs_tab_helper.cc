...
const char* kPrefsToObserve[] = {
  ...
  // Bing Search Engine Changes End
  // Save page feature
  prefs::kWebKitAllowContentURLAccess,
  // For Font Boosting Feature
  prefs::kWebKitFontBoostingModeEnabled,
  // For Imideo Feature
  prefs::kWebKitImideoDebugMode,
  // For Overview Mode
  prefs::kWebkitOverviewModeEnabled,
#endif
};
...
void PrefsTabHelper::RegisterProfilePrefs(
  ...
  registry->RegisterLocalizedIntegerPref(
      ...
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
  #if defined(S_PLM_P140430_02807)
  registry->RegisterBooleanPref(
      prefs::kWebKitUsesUniversalDetector,
  ...
  registry->RegisterBooleanPref(prefs::kWebKitAutocompleteIgnore,
     			     pref_defaults.autocomplete_ignore,
                             user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
  #endif
  ...
  registry->RegisterBooleanPref(
      prefs::kWebkitOverviewModeEnabled,
      pref_defaults.initialize_at_minimum_page_scale,
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
#endif
}
