...
class MediaDrmBridge {
     ...
     */
    private boolean createMediaCrypto() throws android.media.NotProvisionedException, android.media.ResourceBusyException {
        if (mMediaDrm == null) {
            return false;
        }
     ...
     */
    private ByteBuffer openSession() throws android.media.NotProvisionedException, android.media.ResourceBusyException {
     ...
     */
    private void processPendingCreateSessionData() throws android.media.ResourceBusyException {
     ...
     */
    private void resumePendingOperations() throws android.media.ResourceBusyException {
     ...
     */
    @CalledByNative
    private void createSession(int sessionId, byte[] initData, String mime) throws android.media.ResourceBusyException {
     ...
     */
    private void onProvisionResponse(byte[] response) throws android.media.ResourceBusyException{
