    ...
    if (header)
    {
        switch (header->codec)
        {
            ...
            case kRtpVideoH264:
            {
                ...
                _codecSpecificInfo.codecSpecific.H264.forbiddenBit = false;
                _codecSpecificInfo.codecSpecific.H264.nalRefId = 0;
                _codecSpecificInfo.codecSpecific.H264.nalPayloadType = NAL_FU_FORMAT;
                _codecSpecificInfo.codecSpecific.H264.don = 0;
                _codecSpecificInfo.codecSpecific.H264.sBit = true;
                _codecSpecificInfo.codecSpecific.H264.eBit = true;
                _codecSpecificInfo.codecSpecific.H264.rBit = true;
                _codecSpecificInfo.codecSpecific.H264.startDetected = true;
