...
void HTMLInputElement::defaultEventHandler(Event* evt)
{
    ...
    if (m_inputTypeView->shouldSubmitImplicitly(evt)) {
        ...
        if (formForSubmission){
			LOG(INFO)<<"FP: HTMLInputElement::defaultEventHandler :formForSubmission   ";
...
#if defined(S_AUTOFILL_SHOW_FIX)
void HTMLInputElement::setIsCompositionChange(bool value)
{
    m_isCompositionChange = value;
}
#endif
