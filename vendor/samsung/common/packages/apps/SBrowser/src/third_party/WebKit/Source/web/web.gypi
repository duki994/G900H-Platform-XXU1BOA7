{
  'variables': {
    # Samsung-specific web files.
    'extra_web_files': [
      'ArticleRecognition.cpp',
      'ArticleRecognition.h',
      'DOMWindowBingSearchEngineClientImpl.cpp',
      'DOMWindowBingSearchEngineClientImpl.h',
      'LinkHighlightHover.cpp',
      'LinkHighlightHover.h',
    ],
    'web_files': [
      '<@(extra_web_files)',
      ...
      'WebPopupMenuImpl.h',
      'WebPushPermissionRequest.cpp',
      'WebPushPermissionRequestManager.cpp',
      'WebRange.cpp',
    ...
    #['enable_s_android_browser_unittest == 1',
       # {
       #   'web_unittest_files': [
           # 'tests/InputMethodControllerTest.cpp',
       #   ],
      #  }
     # ],
      ['OS=="win"',
