...
public:
    ...
    bool fitToMajorContentsIfNeeded();
    void setMajorContentsWidth(int);
    int majorContentsWidth() const { return m_majorContentsWidth;}
#endif
...
#endif
#if ENABLE(FIT_TO_MAJOR)
    int m_majorContentsWidth;
    int m_majorContentsFitTrialCount;
#endif
};
