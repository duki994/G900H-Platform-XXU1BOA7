...
#define UNSCALED_COMPONENT_OFFSET  0x1000
  ...
  TT_Load_Simple_Glyph( TT_Loader  load )
  {
    ...
    {
// Added by DMC Graphis Lab for remove andorid native side effect
#ifdef FSN_FONT_SOLUTION
      if(!load->face->fetstate.ignore_hinting_instruction) {
...
#ifdef FSN_FONT_SOLUTION
      // Added by DMC Graphis Lab for remove andorid native side effect
      if(!loader->face->fetstate.ignore_hinting_instruction) {
