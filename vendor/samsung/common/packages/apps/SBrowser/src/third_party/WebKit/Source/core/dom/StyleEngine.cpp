...
{
    // When Documents become inactive then they leave the frame tree.
    // During Shutdown, There is a period of time after they become inactive
    // before they are removed from the frame tree.
