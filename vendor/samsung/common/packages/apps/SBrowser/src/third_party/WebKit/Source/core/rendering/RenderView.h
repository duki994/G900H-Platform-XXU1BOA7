...
public:
    ...
    void repaintImageAnimationsIfNeeded();
    void addRendererWithOffscreenAnimations(RenderObject&);
    void removeRenderer(RenderObject&);
...
private:
    ...
    HashSet<RenderObject*> m_renderersWithOffscreenAnimation;
};
