...
bool WebMediaPlayerClientImpl::hasClosedCaptions(){
    return static_cast<HTMLMediaElement*>(m_client)->hasClosedCaptions();
}
bool WebMediaPlayerClientImpl::closedCaptionsVisible(){
    return static_cast<HTMLMediaElement*>(m_client)->closedCaptionsVisible();
}

void WebMediaPlayerClientImpl::setCCVisibility(bool visible)
{
    m_client->mediaPlayerSetCCVisibility(visible);
}
#endif
