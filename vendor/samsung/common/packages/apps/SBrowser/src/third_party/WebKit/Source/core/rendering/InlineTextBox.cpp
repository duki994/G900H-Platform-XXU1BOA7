...
void InlineTextBox::paint(PaintInfo& paintInfo, const LayoutPoint& paintOffset, LayoutUnit /*lineTop*/, LayoutUnit /*lineBottom*/)
{
    ...
    if (paintInfo.phase != PaintPhaseSelection && paintInfo.phase != PaintPhaseTextClip && !isPrinting) {
		...
		// For sub composing region using JPN_IME>>
#if defined(SBROWSER_ENABLE_JPN_COMPOSING_REGION)
...
#if defined(SBROWSER_ENABLE_JPN_COMPOSING_REGION)
void InlineTextBox::paintCompositionBackground(GraphicsContext* context, const FloatPoint& boxOrigin, RenderStyle* style, const Font& font, int startPos, int endPos, Color backgroundColor)
#else
