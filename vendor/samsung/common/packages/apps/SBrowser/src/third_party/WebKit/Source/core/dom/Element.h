...
public:
    ...
    void scrollIntoViewCenter(bool centerAlways = true);
    ...
    ALWAYS_INLINE const AtomicString& localNameInlined() const { return m_tagName.localName(); }
    ...
    virtual void attributeChanged(const QualifiedName&, const AtomicString&, bool sameValue = false, AttributeModificationReason = ModifiedDirectly);
    ...
    void recalcStyle(StyleRecalcChange, Text* nextTextSibling = 0, bool scoped = 0);
...
private:
    ...
    void didModifyAttribute(const QualifiedName&, const AtomicString& newValue, bool sameValue);
