...
public:
   ...
   bool shouldPrintPaintLog(){ return m_shouldPrintPaintLog;}
   void setShouldPrintPaintLog(bool printPaintLog){  m_shouldPrintPaintLog=printPaintLog;}
#endif

#if defined(SBROWSER_OVERVIEW_MODE)
   bool getOverviewToggle(){ return m_overviewToggle;}
   void setOverviewToggle(bool overviewToggle){  m_overviewToggle=overviewToggle;}
 #endif
...
#if defined(SBROWSER_PRINT_PAINT_LOG)
   bool m_shouldPrintPaintLog;
#endif
#if defined(SBROWSER_OVERVIEW_MODE)
   bool m_overviewToggle;
#endif	
};
