...
static const uint16_t shaping_table_expand[][4] =
{
    {0x0000, 0x0000, 0xFEF6, 0x0000}, /* U+FEF5 */
    {0x0000, 0x0000, 0x0000, 0x0000}, /* U+FEF6 */
    {0x0000, 0x0000, 0xFEF8, 0x0000}, /* U+FEF7 */
    {0x0000, 0x0000, 0x0000, 0x0000}, /* U+FEF8 */
    {0x0000, 0x0000, 0xFEFA, 0x0000}, /* U+FEF9 */
    {0x0000, 0x0000, 0x0000, 0x0000}, /* U+FEFA */
    {0x0000, 0x0000, 0xFEFC, 0x0000}, /* U+FEFB */
    {0x0000, 0x0000, 0x0000, 0x0000}, /* U+FEFC */
};

#define SHAPING_TABLE_E_FIRST   0xFEF5
#define SHAPING_TABLE_E_LAST    0xFEFC
