...
#if defined(S_PLM_P141114_05571)
...
public:
    ...
    {
#if defined(S_PLM_P141114_05571)
        if (isRoot() || isPositioned() || createsGroup() || hasClipPath() || hasTransform() || hasHiddenBackface() || hasReflection() || style()->specifiesColumns() || !style()->hasAutoZIndex() || shouldCompositeForActiveAnimations(*this))
#else
