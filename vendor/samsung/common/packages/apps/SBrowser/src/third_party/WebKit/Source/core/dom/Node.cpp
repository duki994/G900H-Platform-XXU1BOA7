...
void Node::setNeedsStyleRecalc(StyleChangeType changeType, StyleChangeSource source, StyleChangeState state)
{
...
void Node::clearNeedsStyleRecalc()
{
    ...
    if (styleChangeState() == NewNodeStyleChangeState)
        setStyleChangeState(NewNodeStyleChangeState);
