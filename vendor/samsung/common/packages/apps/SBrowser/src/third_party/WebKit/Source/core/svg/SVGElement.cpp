...
void SVGElement::attributeChanged(const QualifiedName& name, const AtomicString& newValue, bool sameValue, AttributeModificationReason)
{
    Element::attributeChanged(name, newValue, sameValue);
