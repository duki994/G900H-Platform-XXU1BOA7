...
//S_HTML5_CUSTOM_HANDLER_SUPPORT  START
	@CalledByNative
    public void registerProtocolHandler(String protocol, String url, String title, boolean userGesture) {

    }

   @CalledByNative
    public void unregisterProtocolHandler(String protocol, String url, boolean userGesture) {
