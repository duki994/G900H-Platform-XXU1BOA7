...
IPC_STRUCT_TRAITS_BEGIN(autofill::PasswordFormFillData)
  ...
  IPC_STRUCT_TRAITS_MEMBER(authentication_required)
  #endif
  IPC_STRUCT_TRAITS_MEMBER(selectedUser)
  #if defined(S_FP_HIDDEN_FORM_FIX)
  IPC_STRUCT_TRAITS_MEMBER(form_is_hidden)
  #endif
  IPC_STRUCT_TRAITS_MEMBER(username_list)
  IPC_STRUCT_TRAITS_MEMBER(manual_autofill)
IPC_STRUCT_TRAITS_END()
...
IPC_MESSAGE_ROUTED1(AutofillMsg_ShowAutofillPopupCalled,
					  bool /* showing */)
#endif
...
#if defined(S_FP_HIDDEN_FORM_FIX)
IPC_MESSAGE_ROUTED1(AutofillHostMsg_HiddenFormAutofill,
                                      autofill::PasswordFormFillData /*FormFillData*/)
#endif

#if defined(S_FP_NEW_TAB_FIX)
IPC_MESSAGE_ROUTED0(AutofillHostMsg_RPPCheckBeforeTabClose)
#endif
