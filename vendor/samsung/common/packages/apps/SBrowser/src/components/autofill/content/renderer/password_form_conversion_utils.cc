...
scoped_ptr<PasswordForm> InitPasswordFormFromWebPasswordForm(
  ...
  password_form->username_element_readonly = web_password_form.userNameElementReadOnly;
  ...
  password_form->is_signup_page = web_password_form.isSignUpPage;
  #endif
  LOG(INFO)<<"FP: InitPasswordFormFromWebPasswordForm";
  //LOG(INFO)<<"FP:---------------------------------------------------------";
  //  LOG(INFO)<<"FP: CreatePasswordForm action = "<<password_form->action;
	//  LOG(INFO)<<"FP: CreatePasswordForm origin = "<<password_form->origin;
	//LOG(INFO)<<"FP: CreatePasswordForm username_element = "<<password_form->username_element;  
	//LOG(INFO)<<"FP: CreatePasswordForm username_value = "<<password_form->username_value;
	//LOG(INFO)<<"FP: CreatePasswordForm password_element = "<<password_form->password_element;
	//LOG(INFO)<<"FP: CreatePasswordForm password_value = "<<password_form->password_value;
	//LOG(INFO)<<"FP: CreatePasswordForm submit_element = "<<password_form->submit_element;
	//LOG(INFO)<<"FP: CreatePasswordForm password_autocomplete_set = "<<password_form->password_autocomplete_set;
  //LOG(INFO)<<"FP:---------------------------------------------------------";
...
scoped_ptr<PasswordForm> CreatePasswordForm(const WebFormElement& webform) {
  ...
  LOG(INFO)<<"FP: CreatePasswordForm isVALID = "<<web_password_form.isValid();
