...
public class SelectPopupDialog {
    ...
    protected SelectPopupDialog(ContentViewCore contentViewCore, List<SelectPopupItem> items,
    ...
    protected int getSelectDialogLayout(boolean isMultiChoice) {
        int resourceId;
    ...
    public int[] getSelectedIndices(ListView listView) {
     ...
     */
    public void show(ContentViewCore contentViewCore, List<SelectPopupItem> items,
     ...
     * @param contentView
     */
    public void hide(ContentViewCore contentView) {
