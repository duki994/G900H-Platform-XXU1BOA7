...
#if defined(ENABLE_PUSH_API)
  // Returns the push permission context for this context. It's valid to
  // return NULL, in which case push requests will always be allowed.
  virtual PushPermissionContext* GetPushPermissionContext() = 0;
#endif
};
