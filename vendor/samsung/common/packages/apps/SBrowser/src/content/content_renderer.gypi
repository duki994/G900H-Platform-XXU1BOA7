...

{
  ...
  'sources': [
    ...
    'renderer/push_registration/push_registration_dispatcher.cc',
    'renderer/push_registration/push_registration_dispatcher.h',
  ...
  'conditions': [
    ...
    ['OS=="android" and disable_libphonenumber==0', {
      'dependencies': [
