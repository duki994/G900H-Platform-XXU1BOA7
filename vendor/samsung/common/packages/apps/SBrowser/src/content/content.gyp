    ...
    ['OS == "android"', {
      'targets': [
        ...
        },
        {
          ...
          'type': 'none',
          # Workaround for missing dependency in S-Browser.
          # Should be removed when S-Browser dependencies are fixed.
          'dependencies': [
            'screen_orientation_values_java',
            'content_gamepad_mapping',
          ],
        ...
        },
        {
          ...
          'type': 'none',
          'sources': [
            'public/android/java/src/org/chromium/content/browser/input/gamepad_mapping/CanonicalButtonIndex.template',
            'public/android/java/src/org/chromium/content/browser/input/gamepad_mapping/CanonicalAxisIndex.template',
          ],
          'variables': {
            'package_name': 'org/chromium/content/browser/input/gamepad_mapping',
            'template_deps': [
