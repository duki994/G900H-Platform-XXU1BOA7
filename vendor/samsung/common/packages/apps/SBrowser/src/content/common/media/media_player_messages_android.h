...
// Instructs the video element to toggle the closed caption visibility.
IPC_MESSAGE_ROUTED2(MediaPlayerMsg_SetCCVisibility,
                    int /*player_id */,
                    bool /*visibility*/)

// update closed caption visibility from renderer to browser
IPC_MESSAGE_ROUTED2(MediaPlayerHostMsg_UpdateCCVisibility,
                        int /* player_id */,
                        int /* status */)
...
IPC_MESSAGE_ROUTED2(MediaPlayerHostMsg_UpdateMediaSourceBuffering,
                        int /* player_id */,
                        int /* percentage */)
#endif
