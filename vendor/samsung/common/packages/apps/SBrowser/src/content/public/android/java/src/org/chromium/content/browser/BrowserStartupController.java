...
// fix added for Chromium test cases
    ...
    static void browserStartupComplete(int result) {
        Log.i("[APP_LAUNCH] " + TAG, "browserStartupComplete : Browser process init complete..");
    ...
    void prepareToStartBrowserProcess(int maxRendererProcesses) throws ProcessInitException {
        Log.i("[APP_LAUNCH] " + TAG, "Initializing chromium process, renderers=" + maxRendererProcesses);
