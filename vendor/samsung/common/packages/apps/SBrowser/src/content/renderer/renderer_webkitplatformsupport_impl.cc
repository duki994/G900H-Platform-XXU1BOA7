...
void RendererWebKitPlatformSupportImpl::setGamepadListener(
  ...
  RenderThreadImpl::current()->SetGamepadListener(listener);
}
...
blink::WebScreenOrientation
    RendererWebKitPlatformSupportImpl::currentScreenOrientation() const {
  ASSERT(screen_orientation_dispatcher_);

  return screen_orientation_dispatcher_->currentScreenOrientation();
}
