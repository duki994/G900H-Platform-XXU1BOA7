...
IPC_STRUCT_TRAITS_BEGIN(gfx::GpuMemoryBufferHandle)
  ...
  IPC_STRUCT_TRAITS_MEMBER(handle_fd[0])
  IPC_STRUCT_TRAITS_MEMBER(handle_fd[1])
  IPC_STRUCT_TRAITS_MEMBER(handle_fd[2])
  IPC_STRUCT_TRAITS_MEMBER(handle_fd[3])
  IPC_STRUCT_TRAITS_MEMBER(flattened_buffer)
#endif
IPC_STRUCT_TRAITS_END()
