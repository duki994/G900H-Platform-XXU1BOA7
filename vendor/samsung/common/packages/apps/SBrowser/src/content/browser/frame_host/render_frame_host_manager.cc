...
#if defined(SBROWSER_QC_OPTIMIZATION_PRECREATE_RENDERER)
  GetPreviousAndCreateExtraSiteInstance(site_instance);
#endif
...
#if defined(SBROWSER_QC_OPTIMIZATION_PRECREATE_RENDERER)
 SiteInstance* RenderFrameHostManager::GetPreviousAndCreateExtraSiteInstance(SiteInstance* curr_instance) {
    SiteInstance* prev_site_instance = extra_site_instance_;
    extra_site_instance_ = curr_instance->GetRelatedSiteInstanceWithoutURL();
    return prev_site_instance;
}
#endif
...
#if defined(SBROWSER_QC_OPTIMIZATION_PRECREATE_RENDERER)
  render_view_host->SetExtraSiteInstance(extra_site_instance_);
#endif
...
#if defined(SBROWSER_QC_OPTIMIZATION_PRECREATE_RENDERER)
  SiteInstance* prev_site_instance = GetPreviousAndCreateExtraSiteInstance(instance);
  if (prev_site_instance) {
      scoped_refptr<SiteInstanceImpl> instanceptr = static_cast<SiteInstanceImpl*>(instance);
      instance = prev_site_instance;
  }
#endif
