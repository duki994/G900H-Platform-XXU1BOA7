...
void  InterstitialPageImpl::InterstitialPageRVHDelegateView::
    OnTextFieldBoundsChanged(const gfx::Rect&  input_edit_rect){}
#endif
...
void InterstitialPageImpl::InterstitialPageRVHDelegateView::SavePageFileName(
    const base::FilePath::StringType& pure_file_name) {
}

#if defined(S_FP_AUTOLOGIN_FAILURE_ALERT)
void InterstitialPageImpl::InterstitialPageRVHDelegateView::ShowAutoLoginFailureMsg() {
}
#endif

void InterstitialPageImpl::InterstitialPageRVHDelegateView::OnReceiveBitmapFromCache(
...
void InterstitialPageImpl::InterstitialPageRVHDelegateView::SelectedMarkup(const base::string16& markup) {}
void InterstitialPageImpl::InterstitialPageRVHDelegateView::SetSelectionVisibility(
  bool isVisible) {}
void InterstitialPageImpl::InterstitialPageRVHDelegateView::UpdateSelectionRect(
  const gfx::Rect& selectionRect) {}
void InterstitialPageImpl::InterstitialPageRVHDelegateView::PointOnRegion(
  bool isOnRegion) {}
void InterstitialPageImpl::InterstitialPageRVHDelegateView::SelectedBitmap(
    const SkBitmap& bitmap) {}
void InterstitialPageImpl::InterstitialPageRVHDelegateView::OnOpenUrlInNewTab(const base::string16& url){};
void InterstitialPageImpl::InterstitialPageRVHDelegateView::SetLongPressSelectionPoint(int x, int y){};
void InterstitialPageImpl::InterstitialPageRVHDelegateView::UpdateTouchedFixedElementHeight(int height) {}
#if defined(S_INTUITIVE_HOVER)
void InterstitialPageImpl::InterstitialPageRVHDelegateView::OnHoverHitTestResult(int contentType){}
#endif
}  // namespace content
