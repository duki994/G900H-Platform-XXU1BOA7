    ...
    private static class LocationProviderImpl
        ...
        private void registerForLocationUpdates(boolean isGpsEnabled) {
            ...
            try {
                ...
                bestProvider = mLocationManager.getBestProvider(createCoarseCriteria() , true);

                if (bestProvider != null) {
                    mLocationManager.requestLocationUpdates(bestProvider, 0, 0, this, ThreadUtils.getUiThreadLooper());
                } else {
                    mLocationManager.requestLocationUpdates(0, 0, criteria, this, ThreadUtils.getUiThreadLooper());
                }
                if (isGpsEnabled) {
                    criteria.setAccuracy(Criteria.ACCURACY_FINE);
                    bestProvider = mLocationManager.getBestProvider(createFineCriteria() , true);
                    if (bestProvider != null){
                        mLocationManager.requestLocationUpdates(bestProvider, 0, 0, this, ThreadUtils.getUiThreadLooper());
                    } else {
