...
void WebContentsViewGuest::SavePageFileName(
    const base::FilePath::StringType& pure_file_name) {
}
#if defined(S_SCROLL_EVENT)
void WebContentsViewGuest::OnTextFieldBoundsChanged(const gfx::Rect&  input_edit_rect){}
#endif
...
void WebContentsViewGuest::OnReceiveBitmapFromCache(const SkBitmap& bitmap) {
  ...
  void WebContentsViewGuest::ShowAutoLoginFailureMsg() {
  }
#endif
...
void WebContentsViewGuest::SetSelectionVisibility(bool isVisible) {
}
...
void WebContentsViewGuest::OnOpenUrlInNewTab(const base::string16& url) {
}
void WebContentsViewGuest::SetLongPressSelectionPoint(int x, int y) {
}
void WebContentsViewGuest::UpdateTouchedFixedElementHeight(int height) {}
#if defined(S_INTUITIVE_HOVER)
void WebContentsViewGuest::OnHoverHitTestResult(int contentType) {
}
#endif
