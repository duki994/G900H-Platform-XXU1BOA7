...
public class ContentViewClient {
    ...
    public boolean shouldOverrideKeyEvent(KeyEvent event) {
        ...
        // 1. We don't want to block the device on the renderer for some keys like menu, home, call.
        // 2. There are no WebKit equivalents for some of these keys (see app/keyboard_codes_win.h)
        // Note that these are not the same set as KeyEvent.isSystemKey: for instance, AKEYCODE_MEDIA_* will be dispatched to webkit.
