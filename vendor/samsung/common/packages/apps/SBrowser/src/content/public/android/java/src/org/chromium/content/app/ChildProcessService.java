        ...
        mMainThread = new Thread(new Runnable() {
            ...
            public void run()  {
                try {
                    ...
                    Log.e("[Renderer][Startup]", "[ChildProcessService][onCreate] - Native Initialization start.");
                    ...
                    ContentMain.start();
                    Log.e("[Renderer][Exit]", "[ChildProcessService][onCreate] - Native Initialization Failed.");
