...

{
  ...
  'sources': [
    ...
    'public/android/java/src/org/chromium/content/browser/input/GamepadAdapter.java',
  ...
  'conditions': [
    ['enable_s_android_browser==1', {
     'sources': [
       '../out_jni/ContentVideoView.java',
       '../out_jni/ContentViewCore.java',
       '../out_jni/TracingControllerAndroid.java',
     ],
     'sources!': [
       'public/android/java/src/org/chromium/content/browser/ContentVideoView.java',
       'public/android/java/src/org/chromium/content/browser/ContentViewCore.java',
