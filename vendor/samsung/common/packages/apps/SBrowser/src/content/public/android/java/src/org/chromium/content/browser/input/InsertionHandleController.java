...
public abstract class InsertionHandleController implements CursorController {
    ...
    protected final PositionObserver mPositionObserver;
     ...
     */
    protected class PastePopupMenu implements OnClickListener {
        protected PopupWindow mContainer;
        protected int mPositionX;
        protected int mPositionY;
        protected View[] mPasteViews;
        protected int[] mPasteViewLayouts;
        ...
        protected int viewIndex(boolean onTop) {
            return (onTop ? 0 : 1 << 1) + (canPaste() ? 0 : 1 << 0);
        }

        protected void updateContent(boolean onTop) {
        ...
        protected void positionAtCursor() {
