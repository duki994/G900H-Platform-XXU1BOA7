...
RenderProcessImpl::RenderProcessImpl()
  ...
  LOG(INFO)<<"[Renderer][Startup] RenderProcessImpl::RenderProcessImpl";
#endif
  ...
  std::string blackbox_flag("--black-box-path=/data/data/com.sec.android.app.sbrowser/v8-black-box");
  v8::V8::SetFlagsFromString(blackbox_flag.c_str(), static_cast<int>(blackbox_flag.size()));
#endif
