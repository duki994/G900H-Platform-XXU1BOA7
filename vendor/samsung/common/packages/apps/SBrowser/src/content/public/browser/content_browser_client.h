...
class CONTENT_EXPORT ContentBrowserClient {
 public:
  ...
  // Notification to App that bing is to set as default search engine
  // Can be overriden and implemented by sbrowser
  virtual void SetBingAsCurrentSearchDefault(RenderViewHost* rvh) {}
};
