...
public class ContentViewRenderView extends FrameLayout {
    protected static final int MAX_SWAP_BUFFER_COUNT = 2;
    ...
    protected VSyncAdapter mVSyncAdapter;

    protected int mPendingRenders;
    protected int mPendingSwapBuffers;
    protected boolean mNeedToRender;
    ...
    protected class VSyncAdapter implements VSyncManager.Provider, VSyncMonitor.Listener {
        protected final VSyncMonitor mVSyncMonitor;
        private boolean mVSyncNotificationEnabled;
        protected VSyncManager.Listener mVSyncListener;
        ...
        // chance to arrive.
        protected static final long INPUT_EVENT_LAG_FROM_VSYNC_MICROSECONDS = 3200;

        protected VSyncAdapter(Context context) {
    ...
    protected native boolean nativeCompositeToBitmap(long nativeContentViewRenderView, Bitmap bitmap);
