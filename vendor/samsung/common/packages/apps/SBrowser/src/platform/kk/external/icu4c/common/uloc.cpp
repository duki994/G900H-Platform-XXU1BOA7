...
static const char * const LANGUAGES[] = {
    ...
    "zxx", "zza", "zz",  /* Support for language pseudocode zz_ZZ */
NULL,
...
static const char * const LANGUAGES_3[] = {
    ...
    "zxx", "zza", "eng", /* Support for language pseudocode zz_ZZ */
NULL,
/*  "in",  "iw",  "ji",  "jw",  "sh",                          */
    "ind", "heb", "yid", "jaw", "srp",
NULL
...
static const char * const COUNTRIES[] = {
    ...
    "WS",  "YE",  "YT",  "ZA",  "ZM",  "ZW", "ZZ", /* Support for language pseudocode zz_ZZ */
NULL,
...
/*  "WS",  "YE",  "YT",  "ZA",  "ZM",  "ZW",  "ZZ"        */
    "WSM", "YEM", "MYT", "ZAF", "ZMB", "ZWE", "USA",  /* Support for language pseudocode zz_ZZ */
NULL,
