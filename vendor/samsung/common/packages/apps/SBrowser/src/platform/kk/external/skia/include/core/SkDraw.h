...
//{ Added by DMC.Graphics lab for Font Effect
    ...
    void    drawSFEffect(const char text[], size_t byteLength,
                    SkScalar x, SkScalar y, const SkPaint& paint) const;
    void    drawPosSFEffect(const char text[], size_t byteLength,
                    const SkScalar pos[], SkScalar constY,
                    int scalarsPerPosition, const SkPaint& paint) const;
    void    drawSFEffectBitmap(const SkBitmap&, const SkMatrix&, const SkPaint&) const;
#endif
//}
