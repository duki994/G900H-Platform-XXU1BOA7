...
/*
** Export a database to attached Database.
**
** This API is available only in Samsung version of SQLite.
*/
SQLITE_API void sqlcipher_exportDB(sqlite3 *dbIn, char* attachedDb);
