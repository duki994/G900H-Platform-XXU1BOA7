...
public:
    ...
    enum Config {
        ...
        /**
         * PVRTC2 2bpp with NPOT
         */
        kPVRTC2_2,
        kETC1_AlphaAtlas_Config,
        kETC1_Config,
        kETC2_Alpha_Config,
        kETC2_Config,
        kASTC,
    ...
    */
    ...
    bool getIsIPT() {
        return (fFlags & kImageIsIPT_Flag) != 0;
    }

    void setIsIPT( bool ipt ) {
        if (ipt) {
            fFlags |= kImageIsIPT_Flag;
        } else {
            fFlags &= ~kImageIsIPT_Flag;
        }
    }
...
#endif
        /* A hint for the renderer responsible for drawing this bitmap
         * indicating that it should use indexed palette shader
         */
        kImageIsIPT_Flag        = 0x10,
    };
