...
public:
    ...
    */
     ...
     */
    SkFontEffect* getFontEffect() const;

    /**
     * returning true if text effect is set.
     *
     * @return true if text effect is set.
     */
    bool hasTextEffect() const;

    /**
     * returning the left offset when text effect is set.
     *
     * @return left offset of text effect
     */
    int getTextEffectOffsetLeft() const;

    /**
     * returning the right offset when text effect is set.
     *
     * @return right offset of text effect
     */
    int getTextEffectOffsetRight() const;

    /**
     * returning the top offset when text effect is set.
     *
     * @return top offset of text effect
     */
    int getTextEffectOffsetTop() const;

    /**
     * returning the bottom offset when text effect is set.
     *
     * @return bottom offset of text effect
     */
    int getTextEffectOffsetBottom() const;
     ...
     */
    int addOuterShadowTextEffect(float angle, float offset, float softness, int color, float blendingOpacity);
     ...
     */
    int addInnerShadowTextEffect(float angle, float offset, float softness, int color, float blendingOpacity);
     ...
     */
    int addStrokeTextEffect(float size, int color, float blendingOpacity, int joinStyle, int position);
     ...
     * @param count     count of outer glow gradients
     * @param gradients outer glow gradients
     *
     * @return id of outer glow. if -1, then fail to add outer glow text effect.
     */
    int addOuterGlowTextEffect(float size, int color, float blendingOpacity, int count, SkFontGradient* gradients);
     ...
     * @param count     count of gradients
     * @param gradients gradients
     *
     * @return id of linear gradient. if -1, then fail to add linear gradient text effect.
     */
    int addLinearGradientTextEffect(float angle, float scale, float blendingOpacity, int count, SkFontGradient* gradients);

    /**
     * Removes the text effect.
     *
     * @param id id of text effect. The value is generated by AddXXTextEffect function.
     *
     */
    void removeTextEffect(int id);
     ...
     *
     */
    void setTextEffectOpacity(float blendingOpacity);

    /**
     * Clears the text opacity for text effect.
     *
     */
    void clearTextEffectOpacity();

    /**
     * Clears all of text effect.
     *
     */
    void clearAllTextEffect();
    //}
#endif
    /**
